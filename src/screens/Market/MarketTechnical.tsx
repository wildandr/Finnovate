    ...
    <View style={[tw`h-full `, { backgroundColor: '#002351' }]}>
      <ScrollView>
        ...
        <View style={[tw`flex-row px-4  items-center`,]}>
          <Text style={[tw` text-white font-medium `, { fontSize: 12 }]}>Method : </Text>
          <Text style={[tw`text-white font-medium `, { fontSize: 12 }]}>ARIMA</Text>
        </View>
        ...
        <TouchableOpacity
          ...
          <Text style={[tw`text-white text-center font-bold`,]}>Custom Method</Text>
        </TouchableOpacity>
        </View>
        ...
        <Text style={[tw` text-white font-semibold px-4`, { fontSize: 16 }]}>
          ...
          Lorem ipsum dolor sit amet consectetur. Viverra eleifend lorem leo in tempor tristique amet senectus. Pulvinar nulla ultricies quam vulputate sed. Nibh amet senectus augue in ut. Dictumst turpis ultricies at pellentesque neque augue arcu semper.
          </Text>
          </View>
      </ScrollView>
    </View>
