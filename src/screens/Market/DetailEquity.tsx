...
const DetailEquity = () => {
  ...
  return (
    <View style={[tw`flex-1`, { backgroundColor: '#001D43' }]}>
      ...
      <Text style={[tw`mt-5 px-4 font-semibold`, {color:"#FFBC00", fontSize:22}]}>{equity.name}</Text>
      <Text style={[tw`px-4`, {color:"#CBD5E1", fontSize:14}]}>{equity.company}.</Text>
      <View style={[tw`px-4 flex-row mt-3 items-center justify-between`, ]}>
        ...
        <View style={[tw`px-4 `, ]}>
      <Image source={require('../../assets/chart.png')} style={tw` w-full border border-gray-700 h-64 mt-5 mb-5`} />
      </View>
      <MarketBottomTabs />
